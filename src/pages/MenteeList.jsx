...
const MenteeList = () => {
  ...
  const getRows = () =>{
    axios.get(`https://virtserver.swaggerhub.com/FEBRYANZAINAL/Immersive-Dashboard-OpenAPI/1.0.0/mentees?limit=10&offset=`)
    .then((res)=>{
  ...
  <label tabIndex={0} className="btn bg-white text-black m-1">All Class</label>
  ...
  <label tabIndex={0} className="btn bg-white text-black m-1">All Status</label>
  ...
  <div className='dropdown dropdown-bottom  rounded-box'>
  <label tabIndex={0} className="btn bg-white text-black m-1">All Category</label>
  <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
    <li><a>Informatics</a></li>
    <li><a>Non-Informatics</a></li>
  </ul>
  </div>
