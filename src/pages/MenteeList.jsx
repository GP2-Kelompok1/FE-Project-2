...
const MenteeList = () => {
  ...
  const gRows = async () => {
    await axios
      .post(`http://34.87.101.252:80/mentees`, {
        headers: {
          Authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJleHAiOjE2NzA2NzcxMTAsInJvbGUiOiJkZWZhdWx0IiwidXNlcklkIjoxfQ.c5PgNg1TvnPaaULdExj1m9YdllIf4h-Av7-wlEK4M-o`,
        },
      })
                    ...
                    <label className="modal-box relative" htmlFor="">
                      <div className="bg-white p-5 rounded ">
                        ...
                        <div className="flex flex-col justify-items-center">
                          ...
                          <input type="text" className="border border-alta-dark p-2 rounded mb-5" placeholder="class" />
                          <input type="text" className="border border-alta-dark p-2 rounded mb-5" placeholder="status" />
                          <div className="flex flex-wrap my-2 mb-10 text-sm">
                            <label className="mt-2 mr-10 col-form-label font-semibold">Gender</label>
                      ...
                      return (
                        <tbody className="text-center">
                          <tr className="hover text-alta-dark">
                            ...
                            <td>
                              <button onClick={() => navi('/mentee/detail')}>
                                <MdEdit />
                              </button>
                            </td>
                            <td>
